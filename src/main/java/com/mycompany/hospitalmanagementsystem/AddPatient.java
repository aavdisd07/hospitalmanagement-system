...
public class AddPatient extends javax.swing.JFrame {
    ...
    private void addPatientBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addPatientBtnActionPerformed
        try {
            String name = Validators.requireNonBlank(patientName.getText(), "Patient name");
            int age = Validators.requireInt(patientAge.getText(), "Age");
            String doctorIdRaw = doctorName.getText();
            Integer doctorId = (doctorIdRaw == null || doctorIdRaw.isBlank())
                    ? null
                    : Validators.requireInt(doctorIdRaw, "Doctor ID");
            patientService.add(name, age, doctorId);
            UiErrors.info(this, "Patient added successfully");
            patientId.setText("");
            patientName.setText("");
            patientAge.setText("");
            doctorName.setText("");
