...
public class SearchDoctor extends javax.swing.JFrame {
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        try {
            String name = Validators.requireNonBlank(doctorName.getText(), "Doctor name");
            DefaultTableModel model = (DefaultTableModel) Table.getModel();
            model.setRowCount(0);
            for (Doctor d : doctorService.searchByName(name)) {
                model.addRow(new Object[]{d.id(), d.name(), d.department()});
            }
